    ...
    <div className="space-y-6 text-xs animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-[var(--bg-card)] p-5 rounded-3xl border border-emerald-500/30 bg-emerald-500/5 space-y-1">
          ...
          <p className="text-3xl font-black text-[var(--text-primary)] font-mono">{totalWorkouts} <span className="text-xs font-normal text-[var(--text-secondary)]">Workouts</span></p>
          <p className="text-[10px] text-[var(--text-secondary)]">Healthy consistency track</p>
        </div>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-3xl border border-blue-500/30 bg-blue-500/5 space-y-1">
          ...
          <p className="text-3xl font-black text-[var(--text-primary)] font-mono">{totalMinutes} <span className="text-xs font-normal text-[var(--text-secondary)]">Minutes</span></p>
          <p className="text-[10px] text-[var(--text-secondary)]">Total physical exercise time</p>
        </div>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-3xl border border-amber-500/30 bg-amber-500/5 space-y-1">
          ...
          <p className="text-3xl font-black text-[var(--text-primary)] font-mono">100% <span className="text-xs font-normal text-[var(--text-secondary)]">Active</span></p>
          <p className="text-[10px] text-[var(--text-secondary)]">Non-restrictive wellness focus</p>
        </div>
      </div>
      ...
      {muscleCounts.length > 0 && (
        <div className="bg-[var(--bg-card)] p-6 rounded-3xl border border-[var(--border-color)] space-y-4">
          <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider">Most Trained Target Areas</h3>
              ...
              return (
                <div key={muscle} className="space-y-1">
                  <div className="flex justify-between text-xs text-[var(--text-primary)]">
                    ...
                    <span className="font-mono text-[var(--text-secondary)]">{count} sessions</span>
                  </div>
      ...
      {/* History Log */}
      <div className="bg-[var(--bg-card)] p-6 rounded-3xl border border-[var(--border-color)] space-y-4">
        <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider">Recent Activity Log</h3>
            ...
            {history.map(item => (
              <div key={item.id} className="p-4 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-color)] flex justify-between items-center">
                <div className="space-y-1">
                  ...
                  <h4 className="font-extrabold text-[var(--text-primary)] text-sm">{item.workoutTitle}</h4>
